...
Topic <- c("Intro","Sampling", "Variation, Graphing", "Models", "Writeup",
           ...
           "Experimental design", "ANOVA", "Writeup",
           "Wrapup")
Data <- c(rep("Fish metabolism", 5), rep("Kelp Populations", 4),
          rep("Aquatic invasives", 3), rep("Grassland productivity", 1))
Reading <- c("", 
             "Handout through Data, p. 1-16", 
             "p. 23-43, repeat analysis for P", 
             "p. 539-547", 
             "https://tinyurl.com/fig-capt, p. 149-167, p. 102-104", 
             "Handout through Data, p. 43-47", 
             "p. 65-80", 
             "p. 96-107, 338-340", 
             "p. 176-177",
             "p. 423-445", 
